...
int     main()
{
    ...
    std::string enemi4 = "Mauvais";
    SuperTrap super("Superman");

    super.meleeAttack(enemi4);
    super.rangedAttack(enemi4);
    super.beRepaired(20);
    super.vaulthunter_dot_exe(enemi3);
    super.ninjaShoebox(terminator);
    super.ninjaShoebox(oss);
    super.ninjaShoebox(turtle);
    super.takeDamages(20);
    super.takeDamages(120);
}